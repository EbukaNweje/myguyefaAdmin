...
const [adminWallet, setAdminWaller] = useState()
  ...
  const getallDeposit = () => {
    const url = "https://my-guy-efa-back-end-beryl.vercel.app/api/getallWalletAddress";
    axios.get(url)
        .then((response) => {
...
const handleDelete = (walletId) => {
  ...
  const url = `https://my-guy-efa-back-end-beryl.vercel.app/api/deleteWalletAddress/${walletId}`;
  axios
      .delete(url)
      .then((res) => {
          console.log(res);
